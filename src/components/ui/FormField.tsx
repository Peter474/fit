...
interface FormFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  ...
  error?: string
  suffix?: ReactNode
  /** Set true when `suffix` is a clickable element (e.g. a show/hide password button). */
  ...
  return (
    <div className="mb-3">
      ...
      <div className="relative">
        ...
        {suffix && (
          <span
            className={`absolute right-3.5 top-1/2 -translate-y-1/2 text-xs text-text-tertiary ${
